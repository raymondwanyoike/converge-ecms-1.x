...
public interface NewsItemFacadeLocal {
     ...
     * {@link NewsItem} is published,
     * <code>true</code> is returned, otherwise
     ...
     * @param pagingStart First record to obtain
     * @param pagingRows Number of rows to obtain
     * @param sortBy Field to sort by
     * @param sortDirectory Direction of sort (ASC or DESC)
     * @return {@link ContentResultSet} of inbox items
     */
    ContentResultSet findInbox(java.lang.String username, int pagingStart, int pagingRows, String sortBy, String sortDirection);

    ContentResultSet findNewsItemsByOutlet(String username, Outlet outlet, int pagingStart, int pagingRows, String sortBy, String sortDirection);

    ContentResultSet findNewsItemsByWorkflowState(String username, Outlet outlet, WorkflowState state, int start, int rows, String sortField, String sortDirection);
}
