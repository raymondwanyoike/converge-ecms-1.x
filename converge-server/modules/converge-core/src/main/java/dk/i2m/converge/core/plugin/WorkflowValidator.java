...
/**
 * Interface for implementing a {@link Workflow} validator. Workflow
 * validators can be added to {@link WorkflowStep}s for validation
...
public interface WorkflowValidator extends Plugin {
     ...
     *
     * @param ctx
     *           Context for which the workflow is being executed
     * @param item
