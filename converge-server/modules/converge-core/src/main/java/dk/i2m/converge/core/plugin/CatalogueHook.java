...
/**
 * Interface to implement to hook into event lifecycle of a Catalogue.
 *
...
public abstract class CatalogueHook implements Plugin {
     ...
     */
    public abstract void execute(PluginContext ctx, CatalogueEvent event, CatalogueHookInstance instance) throws CatalogueEventException;
