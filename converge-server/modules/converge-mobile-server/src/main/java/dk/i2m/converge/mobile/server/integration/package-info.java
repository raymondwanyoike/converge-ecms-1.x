 ...
 */
/**
 * The integration package contains classes used for integrating with other
 * Converge products. Currently it contains web service clients for interacting
 * with <em>Converge Editorial</em>.
 */
package dk.i2m.converge.mobile.server.integration;
